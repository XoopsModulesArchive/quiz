...
define('_AM_QUIZ_QUIZS','Quiz');
define('_AM_QUIZ_QUESTIONS','Fragen');
define('_AM_QUIZ_STATISTICS','Statistik');
define('_AM_QUIZ_INDEX','Index');
define('_AM_QUIZ_SEE_SCORE','Users are able to see score after quiz take part');
define('_AM_QUIZ_PERMISSIONS','Berechtigungen');
define('_AM_QUIZ_CATEGORY','Kategorie');
